  ...
  return (
    <div className="w-[370px] h-[] shadow-xl rounded-xl p-[10px]">
        ...
        node={
          <button className="mt-[10px] mr-[10px] bg-[#FFF] w-8 h-8  rounded-full ">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-5 h-5 mx-[6px] text-[#EE685F]"
            >
              <path
                strokeLinecap="round"
      ...
      >
        <Stick
          node={
            <p className="flex items-center gap-1 rounded ml-[10px] mt-[10px] w-[67px] h-[32px] bg-[#FFF]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-8 h-8 text-[#EFC968]"
              >
                <path
                  fillRule="evenodd"
              ...
              <span className="text-[16px] font-normal">4.5</span>
            </p>
          }
          position="top left"
          align="top left"
        ...
        <img
          ...
          src="https://s3-alpha-sig.figma.com/img/68b1/5975/9b40b0cddfcc177d416b074fb912f640?Expires=1691971200&Signature=nRP-JlKMomi9f05Xc4ZWsxtfAhUm9-isIjiyVgbEnTiS8sFTdvTcQQlQ7lwPfZNO7NBiS~nPMGLErmXDQi3McN60rFTT5ced1uS3hnghMy4LHbbrrz0g7gF5vTtPAQH-l94z6LQRRGS1ua9TzeGRZoPqKqNZ3ss2al1dKk3qwu~SZ5Y1fv1OIrmWj3es9iO98CmlOuB7RA2eHNHFOuk90T~5LfpwR6TkzeQUkljrBXo~fbC8FzEkZiPJSnC-ezQGID85og7m4IFAeV66CDxNFmdaEmkABspD0Awz7kX2IkcHiBAFTKrTEK8rtaR8ilkpg-AlhmDT~vbVdHw4ROYT2g__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4"
          alt=""
        />
      </Stick>
      <div>
        <h4 className="text-[22px] text-[#262729] font-normal pt-[25px]">
          Wilderness Club at Big Ceddar
        </h4>
        <p className="text-base text-[#858585]">2 Bedroom Combined Lodge</p>
        <p className="text-lg text[#262729] pt-[5px]">
          28 October — 1 November
        </p>
        <p className="text-[30px] font-normal text-[#2A90D9] pt-[12px]">
          $206<span className="text-xl">/6 night</span>
        </p>
        <div className="py-[10px] flex justify-between">
          <p className="flex gap-2 items-center">
            ...
            <span className="text-[#2A90D9]">4 Bed</span>
          </p>
          <p className="flex gap-2 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="text-[#2A90D9]">4 Sleeps</span>
          </p>
          <p className="flex gap-2 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="text-[#2A90D9]">130 ft</span>
          </p>
        </div>
      </div>
    </div>
